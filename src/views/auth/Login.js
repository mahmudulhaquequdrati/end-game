...
const Login = () => {
  ...
  return (
    <div className=" pt-4 register-bg">
      <div className="flex justify-center">
        <Link to="/">
          <p className="text-center text-3xl font-medium mb-4">DOCTORS APP</p>
        </Link>
      </div>
        ...
        <div className="flex justify-center   rounded-md">
          <div className="w-full rounded-md h-auto  xl:w-3/4 lg:w-full flex">
            <div className="w-full h-full hidden lg:block lg:w-8/12 bg-cover rounded-l-lg">
              <img
                className="h-[95%] w-full rounded-l-md"
                src="https://image.freepik.com/free-vector/sign-concept-illustration_114360-5267.jpg"
                alt=""
              />
            </div>
            <div className="w-full my-auto lg:w-7/12 bg-white p-5 pb-0 rounded-lg lg:rounded-l-none">
